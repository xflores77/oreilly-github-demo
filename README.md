...
The first thing you want to do with this repo is quite likely [**fork it**](https://help.github.com/article/fork-a-repo).  Use the Fork button in the top-right section of the page to do this.
